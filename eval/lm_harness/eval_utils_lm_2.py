...
class BaseLM(LM):
    ...
    def loglikelihood_rolling(self, requests):
        ...
        loglikelihoods = []
        for req in tqdm(requests, leave=False):
    ...
    def _loglikelihood_tokens(self, requests, disable_tqdm=False):
        ...
        for chunk in chunks(
            tqdm(re_ord.get_reordered(), disable=disable_tqdm, leave=False), self.batch_size
        ):
            inps = []
            cont_toks_list = []
            inplens = []
    ...
    def greedy_until(self, requests):
        ...
        for context, until in tqdm(re_ord.get_reordered(), leave=False):
...
class LMEvalAdaptor(BaseLM):
    ...
    def _model_generate(self, context, max_length, eos_token_id):
        return self.model.generate(
            context, max_length=max_length, eos_token_id=eos_token_id, do_sample=False, use_cache=True
        )
